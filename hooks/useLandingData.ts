...
export const useCurrentSubscription = () => {
  return useQuery<{ hasActiveSubscription: boolean; subscription: CurrentSubscription | null }>({
    ...
    queryFn: async () => {
      ...
      return await getWithAuth<{ hasActiveSubscription: boolean; subscription: CurrentSubscription | null }>('/user/subscription');
    },
