...
import { findArticleBySlug, ContentBlock } from "./content";
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="max-w-3xl mx-auto">
              ...
              <span className="inline-block px-2 py-1 text-xs font-medium rounded-full bg-muted mb-3 ml-3 capitalize">
                {article.type}
              </span>
              <h1 className="text-3xl font-bold mb-3">{article.title}</h1>
              <p className="text-foreground/70 mb-8">{article.description}</p>
