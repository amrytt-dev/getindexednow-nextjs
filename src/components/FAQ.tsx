  ...
  const defaultFAQs = [
    {
      ...
      answer:
        "Most URLs are processed within 24-48 hours, though the actual indexing by search engines can vary. Our dashboard provides real-time status updates.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "The number of URLs you can submit depends on your subscription plan. Each plan comes with a specific number of monthly credits that are used for submissions.",
    },
    {
      question: "Do unused credits roll over to the next month?",
      answer:
        "Standard credits don't roll over, but premium subscribers receive a percentage of unused credits carried forward to the next billing period.",
    },
    {
      question: "Can I submit URLs from different websites?",
      answer:
        "Yes, you can submit URLs from any number of different websites under a single account. There's no limit to how many different domains you can use.",
    },
    {
      question: "What happens if I exceed my monthly credits?",
      answer:
        "If you run out of credits, you can upgrade to a higher plan or wait until your credits refresh next month. We'll notify you when you're running low on credits.",
    },
  ];

  // Use data from API if available, otherwise use default FAQs
  const faqsToShow =
    faqsData && faqsData.categories.length > 0
