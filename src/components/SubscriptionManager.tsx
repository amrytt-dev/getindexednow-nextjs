      ...
      <Card className="border-orange-200 bg-orange-50 shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-orange-700 text-base">
            You need an active monthly subscription to access IndexedNow
            features. Subscribe now to get unified credits that refresh every
            month.
          </CardDescription>
        </CardHeader>
      </Card>
      ...
      <Card className="border-blue-200 bg-blue-50 shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-blue-700 text-base">
            Recurring monthly payments with unified credits for indexing and
            checking
          </CardDescription>
        </CardHeader>
      ...
      <Card className="border-green-200 bg-green-50 shadow-md">
        <CardContent className="p-6 text-center">
          ...
          <p className="text-green-700 mb-6">
            ...
            Start indexing your URLs and checking their status immediately after
            subscription.
          </p>
          <Link href="/plans-billing">
